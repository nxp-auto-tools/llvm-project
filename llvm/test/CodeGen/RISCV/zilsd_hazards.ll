...
; Copyright 2024 NXP
;
; RUN: llc -mtriple=riscv32 -mattr=+zilsd -verify-machineinstrs -O0 -mattr=+unaligned-scalar-mem < %s \
...
; RV32ZILSD:            sw	a0, 16(a3)
; RV32ZILSD:            ld	a4, 20(a3)
; RV32ZILSD:            sw	a2, 20(a3)
