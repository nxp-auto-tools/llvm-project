...
# Copyright 2024 NXP
#
# RUN: llvm-mc %s -triple=riscv32 --mattr=+c,+zilsd -riscv-no-aliases -show-encoding \
# RUN:     | FileCheck -check-prefixes=CHECK-ASM,CHECK-ASM-AND-OBJ %s
# RUN: llvm-mc -filetype=obj -triple=riscv32 -mattr=+c,+zilsd < %s \
# RUN:     | llvm-objdump --mattr=+zilsd -M no-aliases -d -r - \
