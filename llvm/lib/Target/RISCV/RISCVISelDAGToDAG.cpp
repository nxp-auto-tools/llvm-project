...
#undef CASE_VMXOR_VMANDN_VMOR_OPCODES
  ...
  case RISCVISD::LD64: {
    ...
    SDValue LoRegIdx = CurDAG->getTargetConstant(RISCV::sub_gpr_even, dl, MVT::i32);
  ...
  case RISCVISD::ST64: {
    ...
    SelectAddrRegImm(Base, Base, Offset);
     ...
     // X0_X0 has a different meaning. It is not represented by a pair,
      ...
      if (ConstantSDNode *ConstantHiVal =
        ...
        if (ConstantLoVal->getZExtValue() == 0 &&
          ...
          ReplaceNode(Node, CurDAG->getMachineNode(
                          ...
                          {CurDAG->getRegister(RISCV::X0_X0, MVT::v2i32),
                           CurDAG->getRegister(RISCV::X0_X0, MVT::v2i32),
                           Base, Offset, Chain}));
          return;
        }
  ...
  case RISCVISD::BUILD_VECTOR: {
    ...
    SDValue SubRegLo = CurDAG->getTargetConstant(RISCV::sub_gpr_even, dl, MVT::i32);
    SDValue SubRegHi = CurDAG->getTargetConstant(RISCV::sub_gpr_odd, dl, MVT::i32);
