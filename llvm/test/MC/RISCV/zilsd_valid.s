...
# Copyright 2024 NXP
#
# RUN: llvm-mc %s -triple=riscv32 --mattr=+c,+experimental-zilsd,+experimental-zclsd -riscv-no-aliases -show-encoding \
# RUN:     | FileCheck -check-prefixes=CHECK-ASM,CHECK-ASM-AND-OBJ %s
# RUN: llvm-mc -filetype=obj -triple=riscv32 -mattr=+c,+experimental-zilsd,+experimental-zclsd < %s \
# RUN:     | llvm-objdump --mattr=+experimental-zilsd,+experimental-zclsd -M no-aliases --no-print-imm-hex -d -r - \
